...
data_t <- read_csv("https://raw.githubusercontent.com/Rajwantmishra/DATA621_CR4/master/HW5/wine-training-data.csv") %>%
  dplyr::select(TARGET, everything())

data_e <- read_csv('https://raw.githubusercontent.com/Rajwantmishra/DATA621_CR4/master/HW5/wine-evaluation-data.csv')
```
