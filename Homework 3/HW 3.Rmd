...
```{r correlation hitmap, fig.cap = "Figure 5: Correlation Pie Chart: Training Set"}
data_t %>%
  cor() %>%
...
```{r include=TRUE, fig.cap = "Figure 6: Correlation Chart: Training Set", echo=TRUE, warning=FALSE, message=FALSE}
